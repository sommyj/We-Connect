...
const _business = require('../server/models/business');

const _business2 = _interopRequireDefault(_business);
...
function copyFile(src, dest) {
  const readStream = _fileSystem2.default.createReadStream(src);
...
describe('Businesses', () => {
  ...
  describe('/GET business', () => {
    it('it should GET all the businesses', (done) => {
      _chai2.default.request(_app2.default).get('/v1/businesses/').end((err, res) => {
  ...
  describe('/POST business', () => {
    it('it should not CREATE a business without description, businessName, userId,\n    description, location and category', (done) => {
      request.post('/v1/businesses/').field('businessId', '1').field('businessName', '').field('userId', '')
        .field('description', '')
        .field('location', '')
        .field('category', '')
    ...
    it('it should CREATE a business', (done) => {
      request.post('/v1/businesses/').field('businessId', '1').field('businessName', 'Sommyj').field('userId', '22')
        ...
        .end((err, res) => {
          ...
          if (_business2.default[0].companyImage) {
            _fileSystem2.default.unlink(`./${_business2.default[0].companyImage}`, (err) => {
              if (err) throw err;
            });
          }
          done();
  ...
  */
  describe('/GET/ business', () => {
    it('it should GET all businesses', (done) => {
      ...
      request.get('/v1/businesses').end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.a('object');
    ...
    it('it should GET a business by the given id', (done) => {
      ...
      request.get(`/v1/businesses/${business.businessId}`).end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.a('object');
        res.body.message.should.be.eql('Success');
        res.body.error.should.be.eql(false);
    ...
    it('it should not GET a business by the given wrong id', (done) => {
      ...
      // Passing business to business model
      _business2.default.push(business);
      request.get('/v1/businesses/13').end((err, res) => {
  ...
  describe('/PUT/:id business', () => {
    it('it should UPDATE a business given the id', (done) => {
      ...
      request.put(`/v1/businesses/${business[0].businessId}`).field('businessId', '1').field('businessName', 'Sommyj Enterprise').field('userId', '22')
    ...
    it('it should not UPDATE a business given the wrong id', (done) => {
      ...
      request.put('/v1/businesses/12').field('businessId', '1').field('businessName', 'Sommyj Enterprise').field('userId', '22')
        .field('description', 'We sale quality products')
        .field('location', 'port-harcourt')
        .field('category', 'Sales')
        .attach('companyImage', './testFile.png')
    ...
    it('it should UPDATE a business given the id and\n    maintain already existing fields and file if none is entered', (done) => {
      ...
      request.put(`/v1/businesses/${business[0].businessId}`).field('businessId', '1').field('businessName', '').field('userId', '')
        .field('description', '')
        .field('location', '')
        .field('category', '')
        .attach('companyImage', '')
    ...
    it('it should UPDATE a business given the id and replace already existing file', (done) => {
      ...
      const src = _path2.default.join('./', filename);
      const destDir = _path2.default.join('./', 'businessesUploads');

      _fileSystem2.default.access(destDir, (err) => {
        if (err) {
      ...
      request.put('/v1/businesses/11').field('businessId', '13').field('businessName', 'Sommyj Enterprise').field('userId', '22')
        .field('description', 'We sale quality products')
        .field('location', 'port-harcourt')
        .field('category', 'Sales')
        .attach('companyImage', './testFile.png')
  ...
  */
  describe('/DELETE/:id business', () => {
    it('it should DELETE a business given the id', (done) => {
      ...
      request.delete('/v1/businesses/11').end((err, res) => {
    ...
    it('it should not DELETE a business given the wrong id', (done) => {
      ...
      // Passing business to business model
      _business2.default.push(business);
      request.delete('/v1/businesses/13').end((err, res) => {
        res.should.have.status(404);
        res.body.should.be.a('object');
        res.body.error.should.be.eql(true);
        res.body.should.have.property('message').eql('Business not found');
  ...
  describe('connect.static()', () => {
    it('should serve static files', (done) => {
      ...
      request.get('/businessesUploads/testFile.png').end(() => {
        // delete test image file
        if (_path2.default.resolve('./businessesUploads/testFile.png')) {
          _fileSystem2.default.unlink('./businessesUploads/testFile.png', (err) => {
            if (err) throw err;
          });
        }
        done();
