...
var _ref = [_models2.default.Business, _models2.default.User],
    Business = _ref[0],
    User = _ref[1];
...
describe('Businesses', function () {
  beforeEach(function (done) {
    ...
    Business.destroy({ where: {}, force: true }).then(function () {
      return done();
    });
  });
  ...
  describe('/POST business', function () {
    it('it should not CREATE a business without description, businessName, userId,\n    description, location and category', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        request.post('/v1/businesses/').set('x-access-token', res.body.token).field('businessName', '').field('description', '').field('street', '').field('city', '').field('state', '').field('country', '').field('datefound', '').field('email', '').field('phone', '').field('category', '').attach('companyImage', './testFile.png').end(function (err, res) {
    ...
    it('it should CREATE a business', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        request.post('/v1/businesses/').set('x-access-token', res.body.token).field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', './testFile.png').end(function (err, res) {
    ...
    it('it should not CREATE a business\n    when image file size is larger than 2mb', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        request.post('/v1/businesses/').set('x-access-token', res.body.token).field('businessId', '1').field('businessName', 'Sommyj').field('userId', '22').field('description', 'We produce quality products').field('location', 'lagos').field('category', 'Production').attach('companyImage', './testFileSize.jpg').end(function (err, res) {
          res.should.have.status(403);
          res.body.should.be.a('object');
    ...
    it('it should not CREATE a business if businessName, email, phone already exist', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        request.post('/v1/businesses/').set('x-access-token', res.body.token).field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', '').end(function () {
          request.post('/v1/businesses/').set('x-access-token', res.body.token).field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', '').end(function (err, res) {
    ...
    it('it should not CREATE a business when a token is not provided', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function () {
        request.post('/v1/businesses/').field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', './testFileType.txt').end(function (err, res) {
    ...
    it('it should not CREATE a business when it fails to authenticate token.', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', './testFileType.txt').end(function () {
        request.post('/v1/businesses/').set('x-access-token', 'jdkjdfskjs43354mxxnzsdz.drfsff.srfsf35324').field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', './testFileType.txt').end(function (err, res) {
  ...
  */
    ...
    it('it should GET a business by the given id', function (done) {
      User.create({
        ...
        Business.create({
          ...
          request.get('/v1/businesses/' + business.dataValues.id).end(function (err, res) {
            res.should.have.status(200);
            res.body.should.be.a('object');
    ...
    it('it should GET a business by the given category', function (done) {
      User.create({
        ...
        Business.create({
          ...
          request.get('/v1/businesses/').query('category=Production') // /businesses?category='Production'
          .end(function (err, res) {
            res.should.have.status(200);
            res.body.should.be.a('array');
    ...
    it('it should GET a business by the given location', function (done) {
      User.create({
        ...
        Business.create({
          ...
          request.get('/v1/businesses').query('location=Nigeria') // /businesses?location='Nigeria'
          .end(function (err, res) {
            res.should.have.status(200);
            res.body.should.be.a('array');
            res.body.should.have.keys('0');
    ...
    it('it should GET a business by the given location && category', function (done) {
      User.create({
        ...
        Business.create({
          ...
          companyImage: '',
          userId: user.dataValues.id
        }).then(function (business1) {
          request.get('/v1/businesses').query({ location: 'Nigeria', category: 'Production' }) // /businesses?location='lagos'&category='Production'
          .end(function (err, res) {
            res.should.have.status(200);
            res.body.should.have.property('0');
  ...
  describe('/PUT/:id business', function () {
    it('it should UPDATE a business given the id', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).field('businessName', 'Sommyj Enterprise').field('description', 'We sale quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'port-harcourt').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Sales').attach('companyImage', './testFile.png').end(function (err, res) {
    ...
    it('it should not UPDATE a business given the wrong id', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.put('/v1/businesses/12').set('x-access-token', res.body.token).field('businessName', 'Sommyj Enterprise').field('description', 'We sale quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'port-harcourt').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Sales').attach('companyImage', './testFile.png').end(function (err, res) {
            res.should.have.status(404);
            res.body.should.be.a('object');
    ...
    it('it should UPDATE a business given the id and\n    maintain already existing fields and file if none is entered', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).field('businessName', '').field('description', '').field('street', '').field('city', '').field('state', '').field('country', '').field('datefound', '').field('email', '').field('phone', '').field('category', '').attach('companyImage', '').end(function (err, res) {
            res.should.have.status(200); // 'success' status
            res.body.should.be.a('object');
            res.body.should.have.property('id').eql(business.dataValues.id);
    ...
    it('it should UPDATE a business given the id and replace already existing file', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).field('businessName', 'Sommy Enterprise').field('description', 'We sale quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'port-harcourt').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Sales').attach('companyImage', './testFile.png').end(function (err, res) {
            res.should.have.status(200); // 'success' status
            res.body.should.be.a('object');
            res.body.should.have.property('id').eql(business.dataValues.id);
            ...
            // delete test image file
            if (_path2.default.resolve('./testFile')) {
              deleteFile('./' + res.body.companyImage);
            }
            done();
          });
    ...
    it('it should not UPDATE a business when image file type not jpg/png', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
    ...
    it('it should not UPDATE a business\n    when image file size is larger than 2mb', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).field('businessName', 'Sommy Limited').field('description', 'We sale quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'port-harcourt').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '02131684').field('category', 'Sales').attach('companyImage', './testFileSize.jpg').end(function (err, res) {
            res.should.have.status(403);
            res.body.should.be.a('object');
            res.body.should.have.property('message').eql('file should not be more than 2mb!');
            res.body.should.have.property('error').eql(true);
    ...
    it('it should not UPDATE a business if businessName, email, phone already exist', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          businessName: 'Sommyj',
          description: 'We produce quality products',
          ...
          Business.create({
            ...
            request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).field('businessName', 'Sommyj').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommyj@gmail.com').field('phone', '021316').field('category', 'Production').attach('companyImage', './testFile.png').end(function (err, res) {
              res.should.have.status(400);
              res.body.should.be.a('object');
              res.body.should.have.property('errors');
              res.body.should.have.property('name').eql('SequelizeUniqueConstraintError');
    ...
    it('it should not UPDATE a business when a token is not provided', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          businessName: 'Sommyj',
          description: 'We produce quality products',
          ...
          request.put('/v1/businesses/' + business.dataValues.id).field('businessName', 'Sommy1').field('userId', 0).field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommy@gmail.com').field('phone', '02131645').field('category', 'Production').attach('companyImage', './testFile.png').end(function (err, res) {
            res.should.have.status(401);
            res.body.should.be.a('object');
            res.body.should.have.property('auth').eql(false);
            res.body.should.have.property('message').eql('No token provided.');
    ...
    it('it should not UPDATE a business when it fails to authenticate token.', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          businessName: 'Sommyj',
          description: 'We produce quality products',
          ...
          request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', 'nferf.edfef.34342').field('businessName', 'Sommy1').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommy@gmail.com').field('phone', '02131645').field('category', 'Production').attach('companyImage', './testFile.png').end(function (err, res) {
            res.should.have.status(500);
            res.body.should.be.a('object');
            res.body.should.have.property('auth').eql(false);
            res.body.should.have.property('message').eql('Failed to authenticate token.');
    ...
    it('it should not UPDATE a business when user is unauthorize.', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman1').field('password', 'abc').field('email', 'justin1@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '669764981').attach('userImage', '').end(function (err, res1) {
        request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res2) {
          Business.create({
            businessName: 'Sommyj',
            description: 'We produce quality products',
            street: '4 jvjvkjvj, kfkjfj',
            ...
            request.put('/v1/businesses/' + business.dataValues.id).set('x-access-token', res1.body.token).field('businessName', 'Sommy1').field('description', 'We produce quality products').field('street', '4, badamus str').field('city', 'Stoppe').field('state', 'Lagos').field('country', 'Nigeria').field('datefound', '2015-11-04').field('email', 'sommy@gmail.com').field('phone', '02131645').field('category', 'Production').attach('companyImage', './testFile.png').end(function (err, res) {
              res.should.have.status(403);
              res.body.should.be.a('object');
              res.body.should.have.property('auth').eql(false);
    ...
    it('it should not DELETE a business given the wrong id', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.delete('/v1/businesses/13').set('x-access-token', res.body.token).end(function (err, res) {
            res.should.have.status(404);
            res.body.should.be.a('object');
            res.body.should.have.property('message').eql('Business not found');
            done();
    ...
    it('it should DELETE a business given the id', function (done) {
      request.post('/auth/v1/signup').field('title', 'mr').field('firstname', 'Justin').field('lastname', 'Ikwuoma').field('username', 'justman').field('password', 'abc').field('email', 'justin@gmail.com').field('gender', 'male').field('street', 'ljan terrasse 346').field('city', 'ikotun').field('state', 'lagos').field('country', 'Nigeria').field('dob', '2015-11-04').field('phone', '66976498').attach('userImage', '').end(function (err, res) {
        Business.create({
          ...
          request.delete('/v1/businesses/' + business.dataValues.id).set('x-access-token', res.body.token).end(function (err, res) {
