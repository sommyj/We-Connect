...
describe('Reviews', function () {
  ...
  describe('/GET review', function () {
    it('it should GET empty reviews', function (done) {
      _chai2.default.request(_app2.default).get('/businesses/1/reviews').end(function (err, res) {
    ...
    it('it should GET all the reviews', function (done) {
      ...
      _chai2.default.request(_app2.default).get('/businesses/2/reviews').end(function (err, res) {
        res.should.have.status(200);
        res.body.Reviews.should.be.a('array');
        res.body.should.have.property('Reviews');
  ...
  describe('/POST review', function () {
    it('it should not POST a review without a response', function (done) {
      ...
      _chai2.default.request(_app2.default).post('/businesses/2/reviews').send(review).end(function (err, res) {
